...
<html lang="fr">
    ...
    <title>{{ config('app.name', 'SIGOBS') }}</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    ...
                    @foreach (session('menus') as $key=>$item)
                            <li class="nav-item parent" id="colapse-{{ $item[0]->id }}" onclick="Collapser(this.id);" style="margin-bottom: 3px">
                                <a href="#" class="nav-link titreMenu majuscule bg-success text-white" id="heading{{ $item[0]->id }}">
                                    ...
                                    @if (!empty($item[1]) )
                                        @foreach ($item[1] as $skey => $sousMenu)
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <a href="{{ $test($sousMenu[0]->lien)  }}/{{$item[0]->id}}/{{$sousMenu[0]->id}}" id="sousMenu{{$sousMenu[0]->id}}">
        ...
        <footer class="main-footer ">
            <div class="d-flex justify-content-center ">
                <strong class="mr-1">Copyright &copy; </strong> <?php $year= date("Y"); echo" <strong > | 2024-$year|</strong>" ;?> <a class="mr-2 ml-2" href="tel:+22664610959"><img  width="50" height="50" src="{{asset('images/logo.png')}}" alt="Logo"></a><a href="#">|Goupe Scolaire les Elites - tous droits réservés</a>.
            </div>
        </footer>
        {{-- <footer class="main-footer">
            <strong class="mr-2">Copyright &copy; </strong> <?php $year= date("Y"); echo" <strong > | 2024-$year|</strong>" ;?> <a class="mr-2 ml-2" href="tel:+22670147315"><img  width="50" height="50" src="{{asset('images/armoirie2.jpg')}}"></a><a href="#">|Projet Repas tous droits réservés</a>.
