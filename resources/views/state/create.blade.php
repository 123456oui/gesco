...
<div class="container-fluid" >
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header py-0">{{ __('Ajouter une Prise en Charge') }}</div>
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="{{ route('pcharge.store') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    value="{{ old('structure') }}" required autofocus onkeyup="this.value = this.value.toUpperCase();">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input name="pmontant" type="number" id="pmontant" value="{{old('pmontant')}}" class="formulaire">
                                    <div class="invalid-feedback">
                                        {{__('formulaire.Obligation')}}
                                    </div>
                                    @error('pmontant')
