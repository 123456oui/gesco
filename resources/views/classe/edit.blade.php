                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="{{ route('classe.store') }}">
                            ...
                            <div class="form-group row">
                                     ...
                                     <div class="col-md-6">
                                            ...
                                            <select name="niveau" id="niveau" class="formulaire" >
                                                  ...
                                                  <option  @selected(old('niveau',$classe->idniveau)==$item->id) value="{{$item->id}}">{{ $item->libelleniveau }} </option>
                                                   @endforeach
                                             </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input name="Annee" id="Annee" value="{{$classe->Annee}}" class="formulaire" onkeyup="this.value = this.value.toUpperCase();">
                                    <div class="invalid-feedback">
                                        {{__('formulaire.Obligation')}}
                                    </div>
                                    @error('Annee')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    value="{{$classe->libelleclasse}}" required autofocus onkeyup="this.value = this.value.toUpperCase();">
